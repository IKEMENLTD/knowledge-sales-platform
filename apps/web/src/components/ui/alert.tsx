  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        cinnabar: 'bg-cinnabar-muted text-cinnabar border-cinnabar/30 [&>svg]:text-cinnabar',
        destructive:
          'bg-destructive/8 text-destructive border-destructive/30 [&>svg]:text-destructive',
        warning: 'bg-ochre-muted text-ochre border-ochre/30 [&>svg]:text-ochre',
        success: 'bg-chitose-muted text-chitose border-chitose/30 [&>svg]:text-chitose',
        info: 'bg-info/10 text-info border-info/25 [&>svg]:text-info',
      },
    },
